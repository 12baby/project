...
import Home from '../views/lookupDrugs/Drugs.vue';
import Store from '../store/index.js'
import RouterArr from './brother'
...
let arry = [
  ...
  {
    path: '/BestSeller',  // 畅销品种
    name: 'BestSeller',
    component: () => import(/* webpackChunkName: "about" */ '../views/bestSeller/BestSeller.vue')
  },
  {
    path: '/Recommend', // 推荐品种
    name: 'Recommend',
